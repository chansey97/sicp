#lang racket
(provide cm-operations cm-registers the-global-environment initialize-machine finalize-machine)
(require "syntax.rkt")
...
(define eceval '())
(define (initialize-machine machine0)
  (set! eceval machine0))
(define (finalize-machine)
  (set! eceval '()))  
...
(define cm-operations
  (list (list 'self-evaluating? self-evaluating?)
        ...
        (list 'compile-and-run-body compile-and-run-body)
        (list 'compile compile-in-machine)
